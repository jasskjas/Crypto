...
def primep():
	p=long((commands.getoutput('openssl prime -generate -bits 2048 -hex')),16)
	q=long((commands.getoutput('openssl prime -generate -bits 2048 -hex')),16)
	n=2	
	while (True): 	
		pas= n * (p * q) + 1
		if (isprime(pas)):
